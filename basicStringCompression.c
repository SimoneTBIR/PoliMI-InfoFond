...
seguito dal numero delle sue occorrenze. Si scriva un programma in linguaggio 
C (ANSI 89) che acquisita in ingresso una stringa di al massimo 50 caratteri 
la comprima. Si consideri che nella stringa compressa il conteggio delle 
...
quella compressa che viene poi visualizzata. Si assuma che la stringa sia composta
solo da caratteri minuscoli dell’alfabeto inglese.
*/
...
idea 2: più naturale e algoritmo più leggero, inoltre mi produce 
		direttamente la stringa che voglio. seguiamo questa.
